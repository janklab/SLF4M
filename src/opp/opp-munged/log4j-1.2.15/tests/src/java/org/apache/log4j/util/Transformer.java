...
public class Transformer {
  ...
  public
  static void transform(String in, String out, Filter[] filters) throws IOException,
  ...
  public
  static void transform(String in, String out, Filter filter) throws IOException,
    UnexpectedFormatException {
